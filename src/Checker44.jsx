...
function Pattern({ goBack }) {
  ...
  const getPredefinedLists = useCallback(() => {
    ...
    { id: 'CARLA  LUCKY 44 NUMBER', name: ' CARLA LUCKY 44 BALLS ', numbers: [], description: 'Numbers that spell BINGO' },
    { id: 'BIMBY  LUCKY 44 NUMBER', name: ' BIMBY LUCKY 44 BALLS ', numbers: [], description: 'Numbers that spell BINGO' },
    { id: 'JUANNA  LUCKY 44 NUMBER', name: ' JUANNA LUCKY 44 BALLS ', numbers: [], description: 'Numbers that spell BINGO' },
    { id: 'FAYE  LUCKY 44 NUMBER', name: 'FAYELUCKY 44 BALLS ', numbers: [], description: 'Numbers that spell BINGO' },
